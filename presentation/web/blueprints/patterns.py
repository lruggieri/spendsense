...
from presentation.web.utils import get_pattern_service, get_category_service, invalidate_service_cache
...
def patterns():
    ...
    response = make_response(render_template('patterns.html',
                                             patterns=patterns_data,
                                             all_categories=categories_hierarchical))
