...
from flask import request, redirect, url_for, flash, make_response, session, g
...
def _check_onboarding_required(user_id: str):
    ...
    from presentation.web.blueprints.onboarding import ONBOARDING_VERSION, needs_onboarding
