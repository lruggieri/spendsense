...
from infrastructure.llm.base_llm_provider import BaseLLMProvider, LLMProviderError, PatternParsingError
...
class TestGeminiProvider(unittest.TestCase):
    ...
    def test_gemini_provider_initialization(self, mock_genai):
        ...
        mock_genai.Client.assert_called_once_with(api_key='test-api-key-12345')
    ...
    def test_gemini_provider_with_explicit_api_key(self, mock_genai):
        ...
        mock_genai.Client.assert_called_once_with(api_key='explicit-key-123')
